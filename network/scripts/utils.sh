...
function printHelp() {
  ...
  if [ "$USAGE" == "prereq" ]; then
    ...
    println "    -i     FabricVersion (default: '2.5.5')"
    ...
    println "    -c <channel name> - Name of channel to create (defaults to \"newchannel\")"
    ...
    println
    println " Examples:"
    println "   network.sh up createChannel -ca -c newchannel -s couchdb "
    println "   network.sh up createChannel -bft -c newchannel -s couchdb "
